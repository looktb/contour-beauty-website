        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12"
          ...
          <div className="lg:col-span-4">
            ...
            <p style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.875rem", lineHeight: 1.8, color: "rgba(250,248,244,0.55)", maxWidth: "30ch" }}>
              Reviderm-Hautbehandlungen und Permanent Make-up in Hamburg. Schönheit, die bleibt.
            </p>
            <div className="flex gap-3 mt-6">
              <a href="https://www.instagram.com/contourbeautyhh/" target="_blank" rel="noopener noreferrer"
                className="transition-opacity hover:opacity-70" style={{ color: "rgba(250,248,244,0.6)" }}>
                <BiLogoInstagram size={20} />
              </a>
              <a href="#" className="transition-opacity hover:opacity-70" style={{ color: "rgba(250,248,244,0.6)" }}>
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            ...
            <ul className="space-y-3">
              {[["Hautbehandlungen", "/hautbehandlungen"], ["Permanent Make-up", "/permanent-make-up"], ["Über uns", "/über-uns"], ["Kontakt", "/kontakt"]].map(([label, href]) => (
                <li key={href}>
                  <a href={href} style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.875rem", color: "rgba(250,248,244,0.6)", textDecoration: "none" }}
                    className="hover:text-cb-cream transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
          <div className="lg:col-span-3">
            ...
            <address style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.875rem", lineHeight: 1.9, color: "rgba(250,248,244,0.6)", fontStyle: "normal" }}>
              Contour Beauty Hamburg<br />Hamburg, Deutschland<br />
              <a href="mailto:info@contour-beauty.de" style={{ color: "rgba(250,248,244,0.6)", textDecoration: "none" }}
                className="hover:text-cb-cream transition-colors">info@contour-beauty.de</a>
            </address>
