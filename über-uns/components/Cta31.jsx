  ...
  return (
    <section className="relative py-24 md:py-32 px-8 md:px-12 lg:px-16 overflow-hidden"
      ...
      <div className="absolute inset-0 opacity-15">
        <img src="/images/skin-2.png" alt="" className="w-full h-full object-cover" />
      </div>
      <div className="relative z-10 max-w-[1440px] mx-auto">
        <div className="max-w-2xl">
          <p className="cb-label mb-6" style={{ color: "var(--cb-sand)" }}>Lern uns kennen</p>
          ...
          <p className="mb-10"
            ...
            Buche ein unverbindliches Erstgespräch und entdecke, was Contour Beauty für dich tun kann.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <a href="/hautbehandlungen" className="cb-btn-light">Behandlungen entdecken</a>
          </div>
        </div>
      </div>
    </section>
