  ...
  return (
    <section className="relative h-screen min-h-[580px] flex items-end">
      <div className="absolute inset-0">
        <img src="/images/treatment-1.png" className="w-full h-full object-cover object-center"
          alt="Permanent Make-up bei Contour Beauty Hamburg" />
        <div className="absolute inset-0"
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-8 md:px-12 lg:px-16 pb-20 md:pb-28">
        <p className="cb-label mb-5" style={{ color: "var(--cb-sand)" }}>Permanent Make-up</p>
        <h1 className="font-display"
          ...
          Natürlich schön. Jeden Tag.
        </h1>
        <p className="mt-6"
          style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "1rem", color: "rgba(250,248,244,0.7)", maxWidth: "38ch" }}>
          Powder Brows, Microblading und Lippenpigmentierung — individuell abgestimmt auf dein Gesicht.
        </p>
      </div>
    </section>
  );
