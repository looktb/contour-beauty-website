      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-12 lg:px-16 py-16 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12"
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-3">
              {[["Datenschutz", "#"], ["Impressum", "#"], ["AGB", "#"]].map(([l, h]) => (
                <li key={l}><a href={h} style={{ fontFamily: "Jost, sans-serif", fontWeight: 300, fontSize: "0.875rem", color: "rgba(250,248,244,0.6)", textDecoration: "none" }}>{l}</a></li>
              ))}
            </ul>
          </div>
        </div>
